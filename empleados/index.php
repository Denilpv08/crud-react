...
if(isset($_GET["insertar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(nombre,apellido,estado) VALUES('$nombre','$apellido','$estado') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
...
if(isset($_GET["actualizar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"UPDATE empleados SET nombre='$nombre',apellido='$apellido',estado='$estado' WHERE Id='$id'");
    echo json_encode(["success"=>1]);
    exit();
}
